...
public class AddRecordGUI extends JFrame {
		...
		btnSave.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				else
				{
					...
					HttpResponse<String> response = req.makeHttpRequest("http://localhost:8080/medicalRecord/" + patientID + "/add","POST", jsonParams, accessToken);
	...
	{
		HttpResponse<String> response = req.makeHttpRequest("http://localhost:8080/doctor/","GET", null, accessToken);
